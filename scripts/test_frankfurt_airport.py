#!/usr/bin/env python3
"""Frankfurt Airport arrivals test."""
...
def main() -> None:
    ...
    payload = {
        "nl_request": "Go to Frankfurt Airport website and find the next arriving flight. Return flight number, origin city, scheduled arrival time, and current status.",
        "schema": {
            "type": "object",
            "properties": {
                "flight_number": {
                    "type": "string",
                    "description": "Flight number (e.g. LH 123)",
                },
        ...
        "target_urls": ["https://www.frankfurt-airport.com/"],
    }

    print("Request: Find next arriving flight at Frankfurt Airport")
